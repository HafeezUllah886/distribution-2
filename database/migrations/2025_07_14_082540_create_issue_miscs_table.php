...
return new class extends Migration
{
    ...
    {
        Schema::create('issue_miscs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('catID')->constrained('employees_payment_cats')->cascadeOnDelete();
            $table->float('amount');
            $table->date('date');
    ...
    {
        Schema::dropIfExists('issue_miscs');
    }
};
