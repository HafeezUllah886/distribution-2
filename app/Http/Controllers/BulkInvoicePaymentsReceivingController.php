...
class BulkInvoicePaymentsReceivingController extends Controller
{
    ...
    {
        $bulkPayment = bulk_payments::where('refID', $ref)->first();
        $customer = $bulkPayment->customer->title;
        $payment = $bulkPayment->method;
        ...
        return to_route('bulk_payment.index')->with('success', 'Bulk Payment Delete Request Sent to Branch Admin');
    }
