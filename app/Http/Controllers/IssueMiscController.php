...
class IssueMiscController extends Controller
{
    ...
    public function delete($ref)
    {
        ...
        $category = employees_payment_cats::find($misc->catID)->name;
        $address = $employee->address;

        $notes = "Issue Misc Date: $misc->date | Employee: $employee->name | Designation: $designation | Department: $department | Address: $address | Category: $category | Amount: $misc->amount | Notes: $misc->notes";
