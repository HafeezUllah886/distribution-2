            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link"
                        href="{{ route('Branch.orders', ['start' => firstDayOfMonth(), 'end' => now()->toDateString()]) }}">
                        <i class="ri-shopping-cart-fill"></i><span data-key="t-apps">Sale Orders</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link menu-link"
                        href="{{ route('purchase_order.index', ['start' => firstDayOfMonth(), 'end' => now()->toDateString()]) }}">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="return">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('return.index', ['start' => firstDayOfMonth(), 'end' => now()->toDateString()]) }}"
                                    class="nav-link" data-key="t-chat"> Sales Return History</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="stock">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('stockTransfers.index') }}" class="nav-link"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('obsolete.index') }}" class="nav-link" data-key="t-chat">Obsolete
                                    Stock</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('targets.index') }}">
                        <i class="ri-focus-2-line"></i> <span data-key="t-my_balance">Targets</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="products">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ url('products/index/') }}/all/all" class="nav-link"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarReports">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('reportBranchInvestment') }}" class="nav-link"
                                    data-key="t-basic-elements">Branch Investment Report</a>
                            </li>
                        </ul>
                    </div>
                </li>
