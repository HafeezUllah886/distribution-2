                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0">{{ auth()->user()->name }}</h5>
                                    <h5 class="fs-14 mb-0">{{ auth()->user()->role }}</h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Current
                                            ...
                                            {{ number_format($cur_balance, 0) }}</span> </h5>
                                    <h5 class="fs-14 mb-0"><small class="text-muted" id="invoice-time">Previous
                                        </small><span id="invoice-date">Rs. {{ number_format($pre_balance, 0) }}</span>
                                    </h5>
                                </div>
                                <!--end col-->
                                <div class="col-lg-3 col-6">
                                ...
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tbody id="products-list">
                                        ...
                                        @foreach ($transactions as $key => $trans)
                                            ...
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td><a href="{{ route('viewAttachment', $trans->refID) }}"
                                                        target="_black">{{ $trans->refID }} <i
                                                            class="ri-attachment-2"></i></a></td>
                                                <td>{{ date('d M Y', strtotime($trans->date)) }}</td>
                                                <td class="text-start"
                                                    style="max-width: 200px; overflow-wrap: break-word; white-space: normal;">
                                                    {{ $trans->notes }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-end p-1 m-0">{{ number_format($transactions->sum('cr'), 0) }}
                                            </th>
                                            <th class="text-end p-1 m-0">{{ number_format($transactions->sum('db'), 0) }}
                                            </th>
