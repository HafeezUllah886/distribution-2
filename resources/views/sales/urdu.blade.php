                        ...
                        <div class="card-body p-4 pt-1 pb-1">
                            <div class="row g-3">
                                ...
                                <div class="col-4">
                                    ...
                                    <h5 class="fs-14 mb-0 "> <span class="text-muted">M/S :</span> <span
                                            class="urdu">{{ $sale->customer->title_urdu }}</span></h5>
                                    @if ($sale->customerID != 2)
                                        ...
                                        <h5 class="fs-14 mb-0"> <span class="text-muted">Address :</span>
                                            {{ $sale->customer->address_urdu ?? 'NA' }}</h5>
                                    @endif
                                ...
                                <div class="col-2">
                                    ...
                                    <h5 class="fs-14 mb-0 text-end" dir="ltr">
                                        {{ date('d M Y', strtotime($sale->date)) }}</h5>
                                </div>
                                <div class="col-3">
                                    <p class="text-muted mb-2 text-uppercase fw-semibold urdu">ٹرانسپورٹ</p>
                                    <h5 class="fs-14 mb-0"><span class="text-muted urdu">بلٹی نمبر :</span>
                                        {{ $sale->bilty ?? 'NA' }}</h5>
                                    <h5 class="fs-14 mb-0"><span class="text-muted urdu">ٹرانسپورٹر :</span>
