                        ...
                        <div class="card-body p-4 pt-1 pb-1">
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <h5 class="fs-14 mb-0"><span class="text-muted">Bilty No :</span>
                                        {{ $sale->bilty ?? 'NA' }}</h5>
                                    <h5 class="fs-14 mb-0"><span class="text-muted">Transporter :</span>
                                        {{ $sale->transporter ?? 'NA' }}</h5>
                                </div>
                                <!--end col-->
                                <!--end col-->
                            </div>
                                ...
                                <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                    ...
                                    <tbody id="products-list">
                                        ...
                                        @foreach ($sale->details as $key => $product)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center m-1 p-1">{{ number_format($product->unit->value) }}
                                                </td>
                                                ...
                                                <td class="text-end p-1 m-1">
                                                    {{ number_format($product->price * $product->unit->value) }}</td>
                                                ...
                                                <td class="text-end p-1 m-1">
                                                    {{ number_format($product->netprice * $product->unit->value) }}</td>
                                    ...
                                    <tfoot>
                                        ...
                                        @if ($sale->has_expense == 1 && $sale->show_expense == 1)
                                            <tr>
                                                <th class="text-end p-1" colspan="13">Expenses (-)</th>
                                                <th class="text-end p-1">
                                                    {{ number_format($sale->expense_amount, 0) }}
                                                </th>
                                            </tr>
                                            <tr>
                                                <th class="text-end p-1" colspan="13">Net Payable</th>
                                                <th class="text-end p-1">
