                        ...
                        <tbody>
                            ...
                            <tr class="{{ $notification->status == 'unread' ? 'table-warning' : '' }}">
                                ...
                                <td>
                                    ...
                                    @case('success')
                                    <span class="badge bg-success">{{ ucfirst($notification->type) }}</span>
                                    @break
                                    @case('error')
                                    <span class="badge bg-danger">{{ ucfirst($notification->type) }}</span>
                                    @break
                                    @case('warning')
                                    <span class="badge bg-warning">{{ ucfirst($notification->type) }}</span>
                                    @break
                                    @default
                                ...
                                <td>
                                    @if($notification->status == 'unread')
                                    <button class="btn btn-sm btn-primary" onclick="markAsRead({{ $notification->id }})">Mark Read</button>
                                    @endif
