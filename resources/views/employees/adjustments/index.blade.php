        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3>Employee Ledger Adjustments</h3>
                ...
                <div class="card-body">
                    ...
                    <table class="table" id="buttons-datatables">
                        ...
                        <tbody>
                            @foreach ($adjustments as $key => $tran)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $tran->refID }}</td>
                                    <td>{{ $tran->user->name }}</td>
                                    <td>{{ $tran->employee->name }}</td>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item text-danger"
                                                        href="{{ route('employee_adjustments.delete', $tran->refID) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Create Ledger Adjustment</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <form action="{{ route('employee_adjustments.store') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mt-2">
                                    <label for="fromID">Employee</label>
                                    <select name="employeeID" id="fromID" required class="selectize">
                                        <option value=""></option>
