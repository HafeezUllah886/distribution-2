                                               ...
                                               <ul class="dropdown-menu dropdown-menu-end">
                                                   ...
                                                   <li>
                                                    <button class="dropdown-item" href="javascript:void(0);"
                                                        onclick="ViewStatment({{ $employee->id }})"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">View Employee Ledger</h5>
...
@section('page-js')
    ...
    <script>
        function ViewStatment(employee)
        {
        ...
        $("#viewBtn").on("click", function (){
            ...
            var from = $("#from").val();
            var to = $("#to").val();
            var url = "{{ route('employee.statement', ['id' => ':employeeID', 'from' => ':from', 'to' => ':to']) }}"
