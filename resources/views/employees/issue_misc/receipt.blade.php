                ...
                <div class="row g-1">
                    ...
                    <div class="col-9">
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ $misc->employee->name }}</td>
                                </tr>
                                <tr>
                                    <td style="width:30%;" class="p-4 pb-1"><strong>Category</strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ $misc->cat->name }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ number_format($misc->amount, 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="width:30%;" class="p-4 pb-1"><strong>Amount in Words</strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        Rupees {{ numberToWords($misc->amount, 2) }} Only</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="width:30%;" class="p-4 pb-1"><strong>Cheque Date</strong></td>
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ $misc->cheque_date ? date('d M Y', strtotime($misc->cheque_date)) : '' }}</td>
                                </tr>
                        ...
                        <div class="card-footer">
                            ...
                            <p><strong>Notes: </strong> {{ $misc->notes }}</p>
