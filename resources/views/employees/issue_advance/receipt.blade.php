                ...
                <div class="row g-1">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mt-sm-0 mt-3">
                                    ...
                                    <p> <span class="text-muted text-uppercase fw-semibold mt-0 m-0 p-0">Receipt Ref #
                                        </span><span class="fs-14 m-0 p-0">{{ $advance->refID }}</span></p>
                                    <p> <span class="text-muted text-uppercase fw-semibold mt-0 m-0 p-0">Date : </span><span
                                            class="fs-14 m-0 p-0">{{ date('d M Y', strtotime($advance->date)) }}</span></p>
                                </div>
                            </div>
                        </div>
                        <!--end card-header-->
                    ...
                    <div class="col-9">
                        <div class="card-body p-4">
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="border-2 border-top-0 border-start-0 border-end-0 text-center p-4 pb-1">
                                        {{ $advance->cheque_date ? date('d M Y', strtotime($advance->cheque_date)) : '' }}</td>
                                </tr>
                        ...
                        <div class="card-footer">
                            ...
                            <p><strong>Notes: </strong> {{ $advance->notes }}</p>
