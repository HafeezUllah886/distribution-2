        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3>View Unloader Labour Charges Report</h3>
                </div>
                <form action="{{ route('reportUnloaderReportData') }}" method="get">
                <div class="card-body">
                    ...
                    <div class="form-group mt-2">
                        <label for="unloader">Unloader</label>
                        <select name="unloader" id="unloader" class="form-control">
                            @foreach ($unloader as $unloader)
