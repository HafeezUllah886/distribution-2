                                    ...
                                    <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                        ...
                                        @foreach ($vendor->products as $product)
                                            <tr>
                                                ...
                                                <td class="text-end">{{ number_format($product->product_unit_value,2) }}</td>
                                                <td class="text-end">{{ number_format($product->product_qty,2) }}</td>
                                        ...
                                        <tr class="table-active">
                                            ...
                                            <td  class="text-end">{{ number_format($vendor->products->sum('product_qty'),2) }}</td>
