                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card-body p-4">
                            ...
                            <div>
                                <table class="table table-bordered text-center table-nowrap align-middle mb-0 w-100"
                                    style="width: 100% !important;border: 1px solid #000000;">
                                    <thead>
                                        <tr class="table-active" style="border: 1px solid #000000;">
                                            ...
                                            <th class="text-start p-1"
                                                style="max-width: 100px; overflow-wrap: break-word; white-space: normal;">
                                                Notes</th>
                                            ...
                                            @if ($payment_account->payments->count() > 0)
                                                ...
                                                @foreach ($payment_account->payments as $payment)
                                                    <tr>
                                                        ...
                                                        <td class="p-1">{{ date('d M Y', strtotime($payment->date)) }}
                                                        </td>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th colspan="8" class="text-end p-1">Total of
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($staffs as $key => $staff)
                                            @if ($staff->payments->count() > 0)
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th colspan="8" class="text-end p-1">Total of {{ $staff->name }}
                                                    </th>
                                                    <th class="text-end p-1">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($customers as $key => $customer)
                                            @if ($customer->salePayments->count() > 0)
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th colspan="10" class="text-end p-1">Total of
                                                        {{ $customer->title }}</th>
                                                    <th class="text-end p-1">
                                        ...
                                        @endforeach
                                        <tr>
                                            <th colspan="10" class="text-end p-1">Total Sale Payments</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($expense_categories as $key => $expense_category)
                                            @if ($expense_category->trans->count() > 0)
                                                ...
                                                @endphp
                                                <tr>
                                                    <th colspan="9" class="p-1 text-start">
                                                        {{ $expense_category->name }}</th>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th colspan="8" class="text-end p-1">Total of
                                                        {{ $expense_category->name }}</th>
                                                    <th class="text-end p-1">
                                                        {{ number_format($expense_category->trans->sum('amount'), 2) }}
                                                    </th>
                                                </tr>
                                            @endif
                                        @endforeach
                                ...
                                <table class="table table-bordered text-center table-nowrap align-middle mb-0 w-100"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-end p-1">{{ number_format($advances->sum('advance'), 2) }}
                                            </th>
                                        </tr>
                                    </tbody>
                                </table><!--end table-->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($emp_payment_cats as $key => $emp_payment_cat)
                                            @if ($emp_payment_cat->trans->count() > 0)
                                                ...
                                                @endphp
                                                <tr>
                                                    <th colspan="10" class="p-1 text-start">
                                                        {{ $emp_payment_cat->name }}</th>
                                                </tr>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th colspan="9" class="text-end p-1">Total of
                                                        {{ $emp_payment_cat->name }}</th>
                                                    <th class="text-end p-1">
                                                        {{ number_format($emp_payment_cat->trans->sum('amount'), 2) }}
                                                    </th>
                                                </tr>
                                            @endif
                                        @endforeach
