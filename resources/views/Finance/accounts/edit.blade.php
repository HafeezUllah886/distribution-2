                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_urdu" value="{{ $account->title_urdu }}"
                                        id="title_urdu" class="form-control">
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="area" id="area" class="form-control">
                                            @foreach ($areas as $area)
                                                <option value="{{ $area->id }}" @selected($account->areaID == $area->id)>
                                                    {{ $area->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            @if ($account->type == 'Customer')
                                <div class="col-6 mt-2 customer">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="address_urdu" id="address_urdu"
                                            value="{{ $account->address_urdu }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6 mt-2 customer">
                                    <div class="form-group ">
                                        ...
                                        <input type="number" min="0" name="limit"
                                            value="{{ $account->credit_limit }}" id="limit" class="form-control">
                                    </div>
                                </div>
                            @endif
