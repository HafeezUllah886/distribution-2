                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="number" step="any" name="pprice" required value=""
                                        min="0" id="pprice" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="fright">Fright</label>
                                    <input type="number" step="any" name="fright" required value="0"
                                        min="0" id="fright" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="claim">Claim</label>
                                    <input type="number" step="any" name="claim" required value="0"
                                        min="0" id="claim" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="labor">Labor Charges</label>
                                    <input type="number" step="any" name="labor" required value="0"
                                        min="0" id="labor" class="form-control">
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2">
                                                    <button class="w-100 btn btn-success" type="button"
                                                        onclick="addUnit()">+</button>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 mt-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" name="price" required value=""
                                        min="0" id="price" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="sfright">Fright</label>
                                    <input type="number" step="any" name="sfright" required value="0"
                                        min="0" id="sfright" class="form-control">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="sclaim">Claim</label>
                                    <input type="number" step="any" name="sclaim" required value="0"
                                        min="0" id="sclaim" class="form-control">
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group mt-2">
                                            <label for="discount">Discount</label>
                                            <input type="number" step="any" name="discount" required value="0"
                                                min="0" id="discount" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group mt-2">
                                            ...
                                            <input type="number" step="any" name="discountp" required
                                                value="0" min="0" id="discountp" class="form-control">
                                        </div>
                                    </div>
