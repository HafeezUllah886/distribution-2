                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <h5 class="fs-14 mb-0"> <span class="text-muted">Order:
                                        </span>{{ date('d M Y', strtotime($purchase->orderdate)) }}</h5>
                                    <h5 class="fs-14 mb-0"> <span class="text-muted">Receiving:
                                        </span>{{ date('d M Y', strtotime($purchase->recdate)) }}</h5>
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <h5 class="fs-14 mb-0"><span id="text-muted">Transporter:
                                        </span>{{ $purchase->transporter }}</h5>
                                            ...
                                            <tbody id="products-list">
                                                ...
                                                @foreach ($purchase->details as $key => $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center m-1 p-1">{{ number_format($product->qty) }}
                                                        </td>
                                                        <td class="text-center m-1 p-1">
                                                            {{ number_format($product->loose) }}</td>
                                                        <td class="text-center m-1 p-1">
                                                            {{ number_format($product->bonus) }}</td>
                                                        <td class="text-end p-1 m-1">{{ number_format($price, 0) }}</td>
                                                        <td class="text-end p-1 m-1">
                                                            {{ number_format($product->discount) }} |
                                                            {{ number_format($discount) }}</td>
                                                        <td class="text-end p-1 m-1">{{ $product->discountp }}% |
                                                            {{ number_format($product->discountvalue) }} |
                                                            {{ number_format($discountvalue) }}</td>
                                                        <td class="text-end p-1 m-1">{{ number_format($product->claim) }} |
                                                            {{ number_format($claim) }}</td>
                                                        <td class="text-end p-1 m-1">{{ number_format($netprice, 0) }}</td>
                                                        <td class="text-end p-1 m-1">{{ number_format($product->fright) }}
                                                            | {{ number_format($fright) }}</td>
                                                        <td class="text-end p-1 m-1">{{ number_format($product->labor) }} |
                                                            {{ number_format($labor) }}</td>
                                                        <td class="text-end p-1 m-1">
                                                            {{ number_format($product->amount, 0) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-end">
                                                        {{ number_format($purchase->details->sum('amount'), 0) }}</th>
                                                </tr>
                                            </tfoot>
                                        </table><!--end table-->
                                    </div>
